...
class Cycle_Suspended_test_course:
    def __init__(self):
        ...
        self.Path_CS = r'\\10.6.220.180\TVD实验室\01.电性能测试\01.电芯测试\1.测试申请单'
        ...
        self.step_21 = ['搁置', '恒流放电', '搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流放电', '搁置']
        self.step_22 = ['搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流恒压充电', '搁置', '恒流放电']
        self.step_23 = ['搁置', '恒流放电', '搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流充电', '恒流充电', '搁置']
        self.step_24 = ['搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置']
        self.step_25 = ['搁置', '恒流放电', '搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置']
        self.step_26 = ['搁置', '恒流放电', '搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流放电', '搁置', '恒流充电', '搁置', '恒流放电', '搁置', '恒流充电', '搁置']
        self.step_27 = ['搁置', '恒流放电', '搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置', '搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流放电', '搁置', '恒流充电', '搁置', '恒流放电', '搁置', '恒流充电', '搁置']
        self.step_28 = ['搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置', '搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流放电', '搁置', '恒流充电', '搁置']
        self.step_29 = ['搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流放电', '搁置', '恒流充电', '搁置']
        self.step_30 = ['搁置', '恒流放电', '搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置']
        self.step_31 = ['搁置', '恒流放电', '搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置', '搁置', '恒流充电', '恒流充电', '搁置']
        self.step_32 = ['搁置', '恒流放电', '搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流放电', '搁置']
        self.step_33 = ['搁置', '恒流放电', '搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置', '搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流放电', '搁置']
        self.step_34 = ['搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置', '搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置',
                   '恒流放电', '搁置']
        self.step_35 = ['搁置', '恒流放电', '搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流恒压充电', '搁置']
        self.step_36 = ['搁置', '恒流放电', '搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置', '搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流放电']
        self.step_37 = ['搁置', '恒流放电', '搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置']
        self.step_38 = ['搁置', '恒流放电', '搁置', '恒流充电', '恒流充电', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流充电', '恒流充电', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流充电', '恒流充电', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流充电', '恒流充电', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流放电', '搁置', '恒流充电', '搁置']
        self.step_39 = ['搁置', '恒流放电', '搁置', '恒流充电', '恒流充电', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流充电', '恒流充电', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流充电', '恒流充电', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流充电', '恒流充电', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流放电', '搁置', '恒流充电', '搁置']
        self.step_40 = ['搁置', '恒流放电', '搁置', '恒流充电', '恒流充电', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流充电', '恒流充电', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流充电', '恒流充电', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流充电', '搁置', '恒流放电', '搁置', '恒流充电', '恒流充电', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流放电', '搁置']
        self.step_41 = ['搁置', '恒流放电', '搁置', '恒流充电', '恒流充电', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流充电', '恒流充电', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流充电', '恒流充电', '恒流恒压充电', '搁置', '恒流放电', '搁置']
        self.step_42 = ['搁置', '恒流充电', '恒流充电', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流放电', '搁置']
        self.step_43 = ['搁置', '恒流放电', '搁置', '恒流充电', '恒流充电', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流充电', '恒流充电', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流充电', '恒流充电', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流充电', '恒流充电', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流放电', '搁置']
        self.step_44 = ['搁置', '恒流放电', '搁置', '恒流充电', '恒流充电', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流充电', '恒流充电', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流充电', '恒流充电', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流充电', '搁置', '恒流放电', '搁置', '恒流充电', '恒流充电', '恒流恒压充电', '搁置', '恒流放电', '搁置', '恒流放电', '搁置', '恒流充电', '搁置']
        ...
        self.step_sum = [self.step_1, self.step_2, self.step_3, self.step_4, self.step_5, self.step_6, self.step_7, self.step_8, self.step_9, self.step_10,
                         ...
                         self.step_21, self.step_22, self.step_23, self.step_24, self.step_25, self.step_26, self.step_27, self.step_28, self.step_29, self.step_30,
                         self.step_31, self.step_32, self.step_33, self.step_34, self.step_35, self.step_36, self.step_37, self.step_38, self.step_39,
                         self.step_40, self.step_41, self.step_42, self.step_43, self.step_44]
        ...
        self.btn4 = Button(self.root, text="图表", command=lambda: 工况_图表.Chart().main(self.root, self.progressbarOne))
    ...
    def Time_To_Float(Time):
        ...
        Time = str(Time)
        if ':' not in Time:
            Time = xlrd.xldate_as_datetime(float(Time), 0)
            Time = Time.strftime("%Y-%m-%d %H:%M:%S.%f").split()[1]
        try:
    ...
    def Get_hyperlink_csd(self):
        Csd_No = self.entry0.get()
        Year = Csd_No[0:4] + '年'
        Month_1 = Csd_No[0:6]
        ...
        if Csd_No.split('-')[1][0] == 'C':
            ...
            if Csd_No.split('-')[0][0:4] == '2025':
                self.Path_CS = r'\\10.6.220.180\TVD实验室\01.电性能测试\01.电芯测试\3.ORT测试申请单\ORT测试申请单'
            else:
                self.Path_CS = r'\\10.6.220.180\TVD实验室\01.电性能测试\01.电芯测试\3.ORT测试申请单\ORT测试申请单'
    ...
    def Get_hyperlink(self, app_data, sht_RPT_0):
            ...
            if '工况' in B_value:
                ...
                for x in range(20):
                    if B_value[x] is not None and '工况' in B_value[x]:
                        index_hyperlink = x
                        break
                if index_hyperlink == 0:
                    if 'Cyclelife' in B_value:
                        index_hyperlink = B_value.index('Cyclelife')
        else:
            if '工况' in B_value:
                index_hyperlink = B_value.index('工况')
        ...
        if Csd_No.split('-')[1][0] == 'O':
            try:
                ...
                if '../../../' in hyperlink:
                    hyperlink = hyperlink.replace(r'../../../', '\\\\10.6.32.6\\01常熟电性能测试\\01.电芯测试\\10.ORT测试申请单\\')
                    if '/' in hyperlink:
                        hyperlink = hyperlink.replace(r'/', '\\')
                elif '..\\..\\..\\' in hyperlink:
                    hyperlink = hyperlink.replace('..\\..\\..\\', '\\\\10.6.32.6\\01常熟电性能测试\\01.电芯测试\\10.ORT测试申请单\\')
                elif '..\\..\\' in hyperlink:
                    hyperlink = hyperlink.replace('..\\..\\', '\\\\10.6.32.6\\01常熟电性能测试\\01.电芯测试\\10.ORT测试申请单\\')
                elif '../../' in hyperlink:
                    hyperlink = hyperlink.replace('../../', '\\\\10.6.32.6\\01常熟电性能测试\\01.电芯测试\\10.ORT测试申请单\\')
                hyperlink = os.path.abspath(hyperlink)
                path = os.listdir(hyperlink)
            except Exception:
                wb_Csd.close()
                return '2'
            list_path = hyperlink.split('\\')  # 超链接定位到测试单号
            index = list_path.index(Csd_No)
            hyperlink = '\\'.join(list_path[0:index + 1])

            Working_condition_list = os.listdir(hyperlink)
            for x in Working_condition_list:
                if '工况' in x:
                    hyperlink = os.path.abspath(os.path.join(hyperlink, x))

        else:
            try:
                hyperlink = sht_csbg.range('k' + str(index_hyperlink + 1)).hyperlink
                if '../../../' in hyperlink:
                    hyperlink = hyperlink.replace(r'../../../', '\\\\10.6.220.180\\TVD实验室\\01.电性能测试\\01.电芯测试\\')
                    if '/' in hyperlink:
                        hyperlink = hyperlink.replace(r'/', '\\')
                elif '..\\..\\..\\' in hyperlink:
                    hyperlink = hyperlink.replace('..\\..\\..\\', '\\\\10.6.220.180\TVD实验室\\01.电性能测试\\01.电芯测试\\')
                elif '..\\..\\' in hyperlink:
                    hyperlink = hyperlink.replace('..\\..\\', '\\\\10.6.220.180\TVD实验室\\01.电性能测试\\01.电芯测试\\')
                elif '../../' in hyperlink:
                    hyperlink = hyperlink.replace('../../', '\\\\10.6.220.180\TVD实验室\\01.电性能测试\\01.电芯测试\\')
                hyperlink = os.path.abspath(hyperlink)
                # if hyperlink.split('\\')[-1] == '工况循环': # 超链接定位到测试单号
                #     hyperlink = hyperlink[0:-5]
                path = os.listdir(hyperlink)
            except Exception:
                wb_Csd.close()
                return '2'
    ...
    def Get_step_message(self, wb_data):
        ...
        if step_index == 0:
            ...
            charge_cap, discharge_cap, charge_energy, discharge_energy, charge_end_V, charge_standing_end_V, discharge_end_V, discharge_standing_end_V, \
            CC_time, total_time, CC_cap, standing_end1_V, discharge_end_V_10, discharge_end_I_10, standing_end2_V, charge_end_V_10, charge_end_I_10, \
            charge_max_tem, discharge_max_tem, charge_max_stress, discharge_max_stress, V_value_record_1, V_value_record_2, charge_cap_value, charge_cap_value_1 = step_function.step_3_1(wb_data, 2)
        elif step_index == 3:
            charge_cap, discharge_cap, charge_energy, discharge_energy, charge_end_V, charge_standing_end_V, discharge_end_V, discharge_standing_end_V, \
            CC_time, total_time, CC_cap, standing_end1_V, discharge_end_V_10, discharge_end_I_10, standing_end2_V, charge_end_V_10, charge_end_I_10, \
            charge_max_tem, discharge_max_tem, charge_max_stress, discharge_max_stress, V_value_record_1, V_value_record_2, charge_cap_value, charge_cap_value_1 = step_function.step_5_1(wb_data, 3)
        elif step_index == 4:
            charge_cap, discharge_cap, charge_energy, discharge_energy, charge_end_V, charge_standing_end_V, discharge_end_V, discharge_standing_end_V, \
            CC_time, total_time, CC_cap, standing_end1_V, discharge_end_V_10, discharge_end_I_10, standing_end2_V, charge_end_V_10, charge_end_I_10, \
            charge_max_tem, discharge_max_tem, charge_max_stress, discharge_max_stress, V_value_record_1, V_value_record_2, charge_cap_value, charge_cap_value_1 = step_function.step_5_1(wb_data, 4)
        elif step_index == 5:
            charge_cap, discharge_cap, charge_energy, discharge_energy, charge_end_V, charge_standing_end_V, discharge_end_V, discharge_standing_end_V, \
            CC_time, total_time, CC_cap, standing_end1_V, discharge_end_V_10, discharge_end_I_10, standing_end2_V, charge_end_V_10, charge_end_I_10, \
            charge_max_tem, discharge_max_tem, charge_max_stress, discharge_max_stress, V_value_record_1, V_value_record_2, charge_cap_value, charge_cap_value_1 = step_function.step_6(wb_data, 5)
        elif step_index == 6:
            charge_cap, discharge_cap, charge_energy, discharge_energy, charge_end_V, charge_standing_end_V, discharge_end_V, discharge_standing_end_V, \
            CC_time, total_time, CC_cap, standing_end1_V, discharge_end_V_10, discharge_end_I_10, standing_end2_V, charge_end_V_10, charge_end_I_10, \
            charge_max_tem, discharge_max_tem, charge_max_stress, discharge_max_stress, V_value_record_1, V_value_record_2, charge_cap_value, charge_cap_value_1 = step_function.step_6(wb_data, 6)
        elif step_index == 7:
            charge_cap, discharge_cap, charge_energy, discharge_energy, charge_end_V, charge_standing_end_V, discharge_end_V, discharge_standing_end_V, \
            CC_time, total_time, CC_cap, standing_end1_V, discharge_end_V_10, discharge_end_I_10, standing_end2_V, charge_end_V_10, charge_end_I_10, \
            charge_max_tem, discharge_max_tem, charge_max_stress, discharge_max_stress, V_value_record_1, V_value_record_2, charge_cap_value, charge_cap_value_1 = step_function.step_8(wb_data, 7)
        elif step_index == 8:
            charge_cap, discharge_cap, charge_energy, discharge_energy, charge_end_V, charge_standing_end_V, discharge_end_V, discharge_standing_end_V, \
            CC_time, total_time, CC_cap, standing_end1_V, discharge_end_V_10, discharge_end_I_10, standing_end2_V, charge_end_V_10, charge_end_I_10, \
            charge_max_tem, discharge_max_tem, charge_max_stress, discharge_max_stress, V_value_record_1, V_value_record_2, charge_cap_value, charge_cap_value_1 = step_function.step_8(wb_data, 8)
        elif step_index == 9:
            charge_cap, discharge_cap, charge_energy, discharge_energy, charge_end_V, charge_standing_end_V, discharge_end_V, discharge_standing_end_V, \
            CC_time, total_time, CC_cap, standing_end1_V, discharge_end_V_10, discharge_end_I_10, standing_end2_V, charge_end_V_10, charge_end_I_10, \
            charge_max_tem, discharge_max_tem, charge_max_stress, discharge_max_stress, V_value_record_1, V_value_record_2, charge_cap_value, charge_cap_value_1 = step_function.step_9_1(wb_data, 9)
        elif step_index == 10:
            charge_cap, discharge_cap, charge_energy, discharge_energy, charge_end_V, charge_standing_end_V, discharge_end_V, discharge_standing_end_V, \
            CC_time, total_time, CC_cap, standing_end1_V, discharge_end_V_10, discharge_end_I_10, standing_end2_V, charge_end_V_10, charge_end_I_10, \
            charge_max_tem, discharge_max_tem, charge_max_stress, discharge_max_stress, V_value_record_1, V_value_record_2, charge_cap_value, charge_cap_value_1 = step_function.step_10_1(wb_data, 10)
        elif step_index == 11:
            charge_cap, discharge_cap, charge_energy, discharge_energy, charge_end_V, charge_standing_end_V, discharge_end_V, discharge_standing_end_V, \
            CC_time, total_time, CC_cap, standing_end1_V, discharge_end_V_10, discharge_end_I_10, standing_end2_V, charge_end_V_10, charge_end_I_10, \
            charge_max_tem, discharge_max_tem, charge_max_stress, discharge_max_stress, V_value_record_1, V_value_record_2, charge_cap_value, charge_cap_value_1 = step_function.step_12(wb_data, 11)
        elif step_index == 12:
            charge_cap, discharge_cap, charge_energy, discharge_energy, charge_end_V, charge_standing_end_V, discharge_end_V, discharge_standing_end_V, \
            CC_time, total_time, CC_cap, standing_end1_V, discharge_end_V_10, discharge_end_I_10, standing_end2_V, charge_end_V_10, charge_end_I_10, \
            charge_max_tem, discharge_max_tem, charge_max_stress, discharge_max_stress, V_value_record_1, V_value_record_2, charge_cap_value, charge_cap_value_1 = step_function.step_13(wb_data, 12)
        elif step_index == 13:
            charge_cap, discharge_cap, charge_energy, discharge_energy, charge_end_V, charge_standing_end_V, discharge_end_V, discharge_standing_end_V, \
            CC_time, total_time, CC_cap, standing_end1_V, discharge_end_V_10, discharge_end_I_10, standing_end2_V, charge_end_V_10, charge_end_I_10, \
            charge_max_tem, discharge_max_tem, charge_max_stress, discharge_max_stress, V_value_record_1, V_value_record_2, charge_cap_value, charge_cap_value_1 = step_function.step_14(wb_data, 13)
        elif step_index == 14:
            charge_cap, discharge_cap, charge_energy, discharge_energy, charge_end_V, charge_standing_end_V, discharge_end_V, discharge_standing_end_V, \
            CC_time, total_time, CC_cap, standing_end1_V, discharge_end_V_10, discharge_end_I_10, standing_end2_V, charge_end_V_10, charge_end_I_10, \
            charge_max_tem, discharge_max_tem, charge_max_stress, discharge_max_stress, V_value_record_1, V_value_record_2, charge_cap_value, charge_cap_value_1 = step_function.step_15(wb_data, 14)
        elif step_index == 15:
            charge_cap, discharge_cap, charge_energy, discharge_energy, charge_end_V, charge_standing_end_V, discharge_end_V, discharge_standing_end_V, \
            CC_time, total_time, CC_cap, standing_end1_V, discharge_end_V_10, discharge_end_I_10, standing_end2_V, charge_end_V_10, charge_end_I_10, \
            charge_max_tem, discharge_max_tem, charge_max_stress, discharge_max_stress, V_value_record_1, V_value_record_2, charge_cap_value, charge_cap_value_1 = step_function.step_16(wb_data, 15)
        elif step_index == 16:
            charge_cap, discharge_cap, charge_energy, discharge_energy, charge_end_V, charge_standing_end_V, discharge_end_V, discharge_standing_end_V, \
            CC_time, total_time, CC_cap, standing_end1_V, discharge_end_V_10, discharge_end_I_10, standing_end2_V, charge_end_V_10, charge_end_I_10, \
            charge_max_tem, discharge_max_tem, charge_max_stress, discharge_max_stress, V_value_record_1, V_value_record_2, charge_cap_value, charge_cap_value_1 = step_function.step_16(wb_data, 16)
        elif step_index == 17:
            charge_cap, discharge_cap, charge_energy, discharge_energy, charge_end_V, charge_standing_end_V, discharge_end_V, discharge_standing_end_V, \
            CC_time, total_time, CC_cap, standing_end1_V, discharge_end_V_10, discharge_end_I_10, standing_end2_V, charge_end_V_10, charge_end_I_10, \
            charge_max_tem, discharge_max_tem, charge_max_stress, discharge_max_stress, V_value_record_1, V_value_record_2, charge_cap_value, charge_cap_value_1 = step_function.step_18(wb_data, 17)
        elif step_index == 18:
            charge_cap, discharge_cap, charge_energy, discharge_energy, charge_end_V, charge_standing_end_V, discharge_end_V, discharge_standing_end_V, \
            CC_time, total_time, CC_cap, standing_end1_V, discharge_end_V_10, discharge_end_I_10, standing_end2_V, charge_end_V_10, charge_end_I_10, \
            charge_max_tem, discharge_max_tem, charge_max_stress, discharge_max_stress, V_value_record_1, V_value_record_2, charge_cap_value, charge_cap_value_1 = step_function.step_19(wb_data, 18)
        elif step_index == 19:
            charge_cap, discharge_cap, charge_energy, discharge_energy, charge_end_V, charge_standing_end_V, discharge_end_V, discharge_standing_end_V, \
            CC_time, total_time, CC_cap, standing_end1_V, discharge_end_V_10, discharge_end_I_10, standing_end2_V, charge_end_V_10, charge_end_I_10, \
            charge_max_tem, discharge_max_tem, charge_max_stress, discharge_max_stress, V_value_record_1, V_value_record_2, charge_cap_value, charge_cap_value_1 = step_function.step_20(wb_data, 19)
        elif step_index == 20:
            charge_cap, discharge_cap, charge_energy, discharge_energy, charge_end_V, charge_standing_end_V, discharge_end_V, discharge_standing_end_V, \
            CC_time, total_time, CC_cap, standing_end1_V, discharge_end_V_10, discharge_end_I_10, standing_end2_V, charge_end_V_10, charge_end_I_10, \
            charge_max_tem, discharge_max_tem, charge_max_stress, discharge_max_stress, V_value_record_1, V_value_record_2, charge_cap_value, charge_cap_value_1 = step_function.step_21(wb_data, 20)
        elif step_index == 21:
            charge_cap, discharge_cap, charge_energy, discharge_energy, charge_end_V, charge_standing_end_V, discharge_end_V, discharge_standing_end_V, \
            CC_time, total_time, CC_cap, standing_end1_V, discharge_end_V_10, discharge_end_I_10, standing_end2_V, charge_end_V_10, charge_end_I_10, \
            charge_max_tem, discharge_max_tem, charge_max_stress, discharge_max_stress, V_value_record_1, V_value_record_2, charge_cap_value, charge_cap_value_1 = step_function.step_22(wb_data, 21)
        elif step_index == 22:
            charge_cap, discharge_cap, charge_energy, discharge_energy, charge_end_V, charge_standing_end_V, discharge_end_V, discharge_standing_end_V, \
            CC_time, total_time, CC_cap, standing_end1_V, discharge_end_V_10, discharge_end_I_10, standing_end2_V, charge_end_V_10, charge_end_I_10, \
            charge_max_tem, discharge_max_tem, charge_max_stress, discharge_max_stress, V_value_record_1, V_value_record_2, charge_cap_value, charge_cap_value_1 = step_function.step_14(wb_data, 22)
        elif step_index == 23:
            charge_cap, discharge_cap, charge_energy, discharge_energy, charge_end_V, charge_standing_end_V, discharge_end_V, discharge_standing_end_V, \
            CC_time, total_time, CC_cap, standing_end1_V, discharge_end_V_10, discharge_end_I_10, standing_end2_V, charge_end_V_10, charge_end_I_10, \
            charge_max_tem, discharge_max_tem, charge_max_stress, discharge_max_stress, V_value_record_1, V_value_record_2, charge_cap_value, charge_cap_value_1 = step_function.step_22(wb_data, 23)
        elif step_index == 24:
            charge_cap, discharge_cap, charge_energy, discharge_energy, charge_end_V, charge_standing_end_V, discharge_end_V, discharge_standing_end_V, \
            CC_time, total_time, CC_cap, standing_end1_V, discharge_end_V_10, discharge_end_I_10, standing_end2_V, charge_end_V_10, charge_end_I_10, \
            charge_max_tem, discharge_max_tem, charge_max_stress, discharge_max_stress, V_value_record_1, V_value_record_2, charge_cap_value, charge_cap_value_1 = step_function.step_25(wb_data, 24)
        elif step_index == 25:
            charge_cap, discharge_cap, charge_energy, discharge_energy, charge_end_V, charge_standing_end_V, discharge_end_V, discharge_standing_end_V, \
            CC_time, total_time, CC_cap, standing_end1_V, discharge_end_V_10, discharge_end_I_10, standing_end2_V, charge_end_V_10, charge_end_I_10, \
            charge_max_tem, discharge_max_tem, charge_max_stress, discharge_max_stress, V_value_record_1, V_value_record_2, charge_cap_value, charge_cap_value_1 = step_function.step_26(wb_data, 25)
        elif step_index == 26:
            charge_cap, discharge_cap, charge_energy, discharge_energy, charge_end_V, charge_standing_end_V, discharge_end_V, discharge_standing_end_V, \
            CC_time, total_time, CC_cap, standing_end1_V, discharge_end_V_10, discharge_end_I_10, standing_end2_V, charge_end_V_10, charge_end_I_10, \
            charge_max_tem, discharge_max_tem, charge_max_stress, discharge_max_stress, V_value_record_1, V_value_record_2, charge_cap_value, charge_cap_value_1 = step_function.step_27(wb_data, 26)
        elif step_index == 27:
            charge_cap, discharge_cap, charge_energy, discharge_energy, charge_end_V, charge_standing_end_V, discharge_end_V, discharge_standing_end_V, \
            CC_time, total_time, CC_cap, standing_end1_V, discharge_end_V_10, discharge_end_I_10, standing_end2_V, charge_end_V_10, charge_end_I_10, \
            charge_max_tem, discharge_max_tem, charge_max_stress, discharge_max_stress, V_value_record_1, V_value_record_2, charge_cap_value, charge_cap_value_1 = step_function.step_28(wb_data, 27)
        elif step_index == 28:
            charge_cap, discharge_cap, charge_energy, discharge_energy, charge_end_V, charge_standing_end_V, discharge_end_V, discharge_standing_end_V, \
            CC_time, total_time, CC_cap, standing_end1_V, discharge_end_V_10, discharge_end_I_10, standing_end2_V, charge_end_V_10, charge_end_I_10, \
            charge_max_tem, discharge_max_tem, charge_max_stress, discharge_max_stress, V_value_record_1, V_value_record_2, charge_cap_value, charge_cap_value_1 = step_function.step_29(wb_data, 28)
        elif step_index == 29:
            charge_cap, discharge_cap, charge_energy, discharge_energy, charge_end_V, charge_standing_end_V, discharge_end_V, discharge_standing_end_V, \
            CC_time, total_time, CC_cap, standing_end1_V, discharge_end_V_10, discharge_end_I_10, standing_end2_V, charge_end_V_10, charge_end_I_10, \
            charge_max_tem, discharge_max_tem, charge_max_stress, discharge_max_stress, V_value_record_1, V_value_record_2, charge_cap_value, charge_cap_value_1 = step_function.step_30(wb_data, 29)
        elif step_index == 30:
            charge_cap, discharge_cap, charge_energy, discharge_energy, charge_end_V, charge_standing_end_V, discharge_end_V, discharge_standing_end_V, \
            CC_time, total_time, CC_cap, standing_end1_V, discharge_end_V_10, discharge_end_I_10, standing_end2_V, charge_end_V_10, charge_end_I_10, \
            charge_max_tem, discharge_max_tem, charge_max_stress, discharge_max_stress, V_value_record_1, V_value_record_2, charge_cap_value, charge_cap_value_1 = step_function.step_14(wb_data, 30)
        elif step_index == 31:
            charge_cap, discharge_cap, charge_energy, discharge_energy, charge_end_V, charge_standing_end_V, discharge_end_V, discharge_standing_end_V, \
            CC_time, total_time, CC_cap, standing_end1_V, discharge_end_V_10, discharge_end_I_10, standing_end2_V, charge_end_V_10, charge_end_I_10, \
            charge_max_tem, discharge_max_tem, charge_max_stress, discharge_max_stress, V_value_record_1, V_value_record_2, charge_cap_value, charge_cap_value_1 = step_function.step_31(wb_data, 31)
        elif step_index == 32:
            charge_cap, discharge_cap, charge_energy, discharge_energy, charge_end_V, charge_standing_end_V, discharge_end_V, discharge_standing_end_V, \
            CC_time, total_time, CC_cap, standing_end1_V, discharge_end_V_10, discharge_end_I_10, standing_end2_V, charge_end_V_10, charge_end_I_10, \
            charge_max_tem, discharge_max_tem, charge_max_stress, discharge_max_stress, V_value_record_1, V_value_record_2, charge_cap_value, charge_cap_value_1 = step_function.step_32(wb_data, 32)
        elif step_index == 33:
            charge_cap, discharge_cap, charge_energy, discharge_energy, charge_end_V, charge_standing_end_V, discharge_end_V, discharge_standing_end_V, \
            CC_time, total_time, CC_cap, standing_end1_V, discharge_end_V_10, discharge_end_I_10, standing_end2_V, charge_end_V_10, charge_end_I_10, \
            charge_max_tem, discharge_max_tem, charge_max_stress, discharge_max_stress, V_value_record_1, V_value_record_2, charge_cap_value, charge_cap_value_1 = step_function.step_33(wb_data, 33)
        elif step_index == 34:
            charge_cap, discharge_cap, charge_energy, discharge_energy, charge_end_V, charge_standing_end_V, discharge_end_V, discharge_standing_end_V, \
            CC_time, total_time, CC_cap, standing_end1_V, discharge_end_V_10, discharge_end_I_10, standing_end2_V, charge_end_V_10, charge_end_I_10, \
            charge_max_tem, discharge_max_tem, charge_max_stress, discharge_max_stress, V_value_record_1, V_value_record_2, charge_cap_value, charge_cap_value_1 = step_function.step_34(wb_data, 34)
        elif step_index == 35:
            charge_cap, discharge_cap, charge_energy, discharge_energy, charge_end_V, charge_standing_end_V, discharge_end_V, discharge_standing_end_V, \
            CC_time, total_time, CC_cap, standing_end1_V, discharge_end_V_10, discharge_end_I_10, standing_end2_V, charge_end_V_10, charge_end_I_10, \
            charge_max_tem, discharge_max_tem, charge_max_stress, discharge_max_stress, V_value_record_1, V_value_record_2, charge_cap_value, charge_cap_value_1 = step_function.step_3_1(wb_data, 2)
            ...
            charge_cap, discharge_cap, charge_energy, discharge_energy, charge_end_V, charge_standing_end_V, discharge_end_V, discharge_standing_end_V, \
            CC_time, total_time, CC_cap, standing_end1_V, discharge_end_V_10, discharge_end_I_10, standing_end2_V, charge_end_V_10, charge_end_I_10, \
            charge_max_tem, discharge_max_tem, charge_max_stress, discharge_max_stress, V_value_record_1, V_value_record_2, charge_cap_value, charge_cap_value_1 = step_function.step_37(
                wb_data, 2)
        elif step_index == 37:
            charge_cap, discharge_cap, charge_energy, discharge_energy, charge_end_V, charge_standing_end_V, discharge_end_V, discharge_standing_end_V, \
            CC_time, total_time, CC_cap, standing_end1_V, discharge_end_V_10, discharge_end_I_10, standing_end2_V, charge_end_V_10, charge_end_I_10, \
            charge_max_tem, discharge_max_tem, charge_max_stress, discharge_max_stress, V_value_record_1, V_value_record_2, charge_cap_value, charge_cap_value_1 = step_function.step_38(
                wb_data, 38)
        elif step_index == 38:
            charge_cap, discharge_cap, charge_energy, discharge_energy, charge_end_V, charge_standing_end_V, discharge_end_V, discharge_standing_end_V, \
            CC_time, total_time, CC_cap, standing_end1_V, discharge_end_V_10, discharge_end_I_10, standing_end2_V, charge_end_V_10, charge_end_I_10, \
            ...
            charge_cap, discharge_cap, charge_energy, discharge_energy, charge_end_V, charge_standing_end_V, discharge_end_V, discharge_standing_end_V, \
            CC_time, total_time, CC_cap, standing_end1_V, discharge_end_V_10, discharge_end_I_10, standing_end2_V, charge_end_V_10, charge_end_I_10, \
            charge_max_tem, discharge_max_tem, charge_max_stress, discharge_max_stress, V_value_record_1, V_value_record_2, charge_cap_value, charge_cap_value_1 = step_function.step_42(
                wb_data, 42)
        elif step_index == 42:
            charge_cap, discharge_cap, charge_energy, discharge_energy, charge_end_V, charge_standing_end_V, discharge_end_V, discharge_standing_end_V, \
            CC_time, total_time, CC_cap, standing_end1_V, discharge_end_V_10, discharge_end_I_10, standing_end2_V, charge_end_V_10, charge_end_I_10, \
    ...
    def Main(self):
        ...
        Cycle_list = [x for x in Cycle_list if re.search(r"(-?\d+)", x) is not None]
        ...
        for i in range(len(Cycle_list)):
            ...
            Data_list = [x for x in Data_list if x[0:2] != '~$']
            ...
            for j in range(len(Data_list)):
                Data_DCR_list = os.listdir(Data_path)
                Data_DCR_list = [x for x in Data_DCR_list if x[0:2] != '~$']
                if Data_DCR_list[j] == '电压标定':
                    continue
                DCR_path = Data_path+'\\'+Data_DCR_list[j]
                print(Data_DCR_list[j])
                if '小电流测试' == Data_DCR_list[j]:
                    print(12)
                    continue
                if os.path.isdir(DCR_path):
                    Data_list = os.listdir(DCR_path)
                    Data_list = [x for x in Data_list if x[0:2] != '~$' and x[-4:] == 'xlsx']
                    try:
                        Data_Barcode = [x.split('-')[3] for x in Data_list]
                    except IndexError:
                    ...
                    for x in range(len(Data_list)):
                        if Data_Barcode != [] and Data_Barcode[x] in barcode_value:
                            barcode_names = 'DVDQ-' + str(Data_Barcode[x])
                        elif Data_Barcode_1[x] in barcode_value:
                            barcode_names = 'DVDQ-' + str(Data_Barcode_1[x])
                        elif Data_Barcode_2 != [] and Data_Barcode_2[x] in barcode_value:
                            barcode_names = 'DVDQ-' + str(Data_Barcode_2[x])
                        else:
                            continue
                        try:
                            ...
                            for y in sheet_namaes:
                                if barcode_names in y:
                                    barcode_names = y
                                    break
                        ...
                        try:
                            barcode_index = C_value.index(Data_Barcode[x])
                        except ValueError:
                            try:
                                barcode_index = C_value.index(Data_Barcode_1[x])
                            except ValueError:
                                continue
                        except IndexError:
                            try:
                        ...
                        # row_Cycle_No = i
                        row_1 = sht_RPT[barcode_index + 2:barcode_index + 3, 2:3].expand('table').rows.count - 1
                        row_2 = sht_RPT[barcode_index + 2:barcode_index + 3, 28:29].expand('table').rows.count - 1

                        row_Cycle_No = min(row_1, row_2)
                        panyi_3 = sht_RPT[barcode_index + 3 + i:barcode_index + 4 + i, 2:3].value
                        # if panyi_3 is not None and panyi_1 is not None and panyi_2 is not None:  # 若已经对应值跳过  and sht_RPT[barcode_index + 3+i:barcode_index + 4+i, 28:29].value is not None
                        #     continue
                        ...
                        list_cycle = [x if x != 'BF' else 0 for x in list_cycle]
                        list_cycle = [x if x != 'AF' else 9000000000 for x in list_cycle]
                        if Cycle_No_j == 9000000000 or Cycle_No_j == 'AF':  # 可能会反
                            Cycle_No_j = 9000000000
                        if Cycle_No_j == 0 or Cycle_No_j == 'BF':  # 可能会反
                            Cycle_No_j = 0


                        if int(Cycle_No_j) in list_cycle:  # or int(Cycle_No_j) == 9000000000 # and panyi_1 is not None and panyi_2 is not None
                            index_Cycle = list_cycle.index(int(Cycle_No_j))
                            panyi_1 = sht_RPT[barcode_index + 3 + index_Cycle:barcode_index + 4 + index_Cycle, 28:29].value
                            panyi_2 = sht_RPT[barcode_index + 3 + index_Cycle:barcode_index + 4 + index_Cycle, 3:4].value
                            if panyi_1 == '-':
                                row_Cycle_No = row_Cycle_No - 1
                            if panyi_1 is not None and panyi_2 is not None and panyi_1 != '-':
                                continue

                        try:
                            wb_data = app_data.books.open(os.path.join(DCR_path, Data_list[x]))
                        except Exception:
                            tkinter.messagebox.showinfo(message=os.path.join(DCR_path, Data_list[x]) + '  打不开')
                            continue
                        ...
                        charge_cap, discharge_cap, charge_energy, discharge_energy, charge_end_V, charge_standing_end_V, discharge_end_V, discharge_standing_end_V, \
                        CC_time, total_time, CC_cap, standing_end1_V, discharge_end_V_10, discharge_end_I_10, standing_end2_V, charge_end_V_10, charge_end_I_10, \
                        charge_max_tem, discharge_max_tem, charge_max_stress, discharge_max_stress, V_value_record_1, V_value_record_2, charge_cap_value, charge_cap_value_1 = self.Get_step_message(
                            wb_data)

                        judge_1 = sht_RPT[barcode_index + 2 + row_Cycle_No:barcode_index + 2 + row_Cycle_No, 2:3].value
                        if charge_cap == 0:  # or judge_1 == Cycle_No
                            wb_data.close()
                            continue

                        if Data_Barcode != [] and Data_Barcode[x] in D_Summary:
                            barcode_index_0 = D_Summary.index(Data_Barcode[x])
                        elif Data_Barcode_1[x] in D_Summary:
                            barcode_index_0 = D_Summary.index(Data_Barcode_1[x])
                        else:
                            barcode_index_0 = []

                        if barcode_index_0 != []:
                            Cycle_Summary = sht_Summary[barcode_index_0:barcode_index_0 + 1, 8:9].value
                            if Cycle_Summary == 'AF':
                                Cycle_Summary = 9000000000
                            if Cycle_Summary == 'BF':
                                Cycle_Summary = 0
                            if Cycle_Summary is None or int(Cycle_Summary) <= int(Cycle_No_j):
                                if Cycle_No_j == 9000000000:
                                    Cycle_No_j = 'AF'
                                if Cycle_No_j == 0:
                                    Cycle_No_j = 'BF'
                                sht_Summary[barcode_index_0:barcode_index_0 + 1, 8:9].value = Cycle_No_j
                                if sht_Summary[barcode_index_0:barcode_index_0 + 1, 9:10].value is None and i == 0:
                                    sht_Summary[barcode_index_0:barcode_index_0 + 1, 9:10].value = discharge_cap
                                if sht_Summary[barcode_index_0:barcode_index_0 + 1, 12:13].value is None and i == 0:
                                    sht_Summary[barcode_index_0:barcode_index_0 + 1, 12:13].value = Test_time[1]
                                if discharge_cap != None:
                                    sht_Summary[barcode_index_0:barcode_index_0 + 1, 10:11].value = discharge_cap
                                sht_Summary[barcode_index_0:barcode_index_0 + 1, 13:14].value = Test_time[1]
                        if Cycle_No_j == 9000000000:
                            Cycle_No_j = 'AF'
                        if sht_RPT[barcode_index + 3 + row_Cycle_No:barcode_index + 4 + row_Cycle_No, 3:4].value is None:
                        ...
                        if standing_end1_V == None:
                            sht_RPT[barcode_index + 3 + row_Cycle_No:barcode_index + 4 + row_Cycle_No, 27:28].value = ['-', '-', '-']
                            sht_RPT[barcode_index + 3 + row_Cycle_No:barcode_index + 4 + row_Cycle_No, 31:32].value = ['-', '-', '-']
                        else:
                        ...
                        if type(charge_cap_value_1) == np.ndarray:
    ...
    def clear(self):
        ...
        # sht_RPT[772:, 0:40].clear_contents()


        for i in range(len(index_list)):
            sht_RPT[index_list[i] - 2:index_list[i] - 1, 2:3].clear_contents()
            sht_RPT[index_list[i] + 1:index_list[i]+31+30, 1:7].clear_contents()
            sht_RPT[index_list[i] + 1:index_list[i]+31+30, 12:13].clear_contents()
            sht_RPT[index_list[i] + 1:index_list[i]+31+30, 14:16].clear_contents()
            sht_RPT[index_list[i] + 1:index_list[i]+31+30, 21:23].clear_contents()
            sht_RPT[index_list[i] + 1:index_list[i]+31+30, 24:26].clear_contents()
            sht_RPT[index_list[i] + 1:index_list[i]+31+30, 27:30].clear_contents()
            sht_RPT[index_list[i] + 1:index_list[i]+31+30, 31:34].clear_contents()
            sht_RPT[index_list[i] + 1:index_list[i]+31+30, 35:39].clear_contents()
    ...
    def Barcode_write(self):
        ...
        file_path_hyperlink = self.Get_hyperlink_csd()
        sht_RPT[0:1, 2:3].value = self.entry0.get()
        sht_RPT[0:1, 2:3].add_hyperlink(file_path_hyperlink, sht_RPT[0:1, 2:3].value, file_path_hyperlink)
        ...
        for i in range(len(Barcode_value)):
            sht_RPT[1+64*i:2+64*i, 2:3].value = Barcode_value[i]# 34 +23+7
        if hyperlink == '2':
            tkinter.messagebox.showinfo(message='测试报告 无工况对应超链接')
            return
